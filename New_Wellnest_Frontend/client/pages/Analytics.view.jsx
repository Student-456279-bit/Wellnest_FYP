    ...
    <div className="w-full pt-8 pb-8">
      <div className="max-w-7xl mx-auto px-4 space-y-8">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <button className="bg-purple-600 text-white px-5 py-2 rounded-full shadow-md flex items-center gap-2 hover:bg-purple-700 transition-colors">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-slate-100 mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <button className="bg-purple-600 text-white px-6 py-3 rounded-lg shadow-md flex items-center justify-center gap-2 hover:bg-purple-700 transition-colors">
                    <Check size={20} /> Update Today
                </button>
                <button className="bg-blue-600 text-white px-6 py-3 rounded-lg shadow-md flex items-center justify-center gap-2 hover:bg-blue-700 transition-colors">
                    <Sliders size={20} /> Modify Goal Plan
                </button>
                <button className="bg-green-600 text-white px-6 py-3 rounded-lg shadow-md flex items-center justify-center gap-2 hover:bg-green-700 transition-colors">
                    <Eye size={20} /> View Goal Progress
                </button>
                <button className="bg-orange-600 text-white px-6 py-3 rounded-lg shadow-md flex items-center justify-center gap-2 hover:bg-orange-700 transition-colors">
